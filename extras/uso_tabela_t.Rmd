...
* Cada número em uma tabela de probabilidade é resultado de inúmeros cálculos (hoje em dia não temos tanto problema com isso).  
...
\clearpage
Exemplos para se calcular $P(Y < y) = 0,975$, (assuma $\nu = 15$ para **t** e **Qui-Quadrado**)
...
* Tente para a distribuição **t** e **qui-quadrado***...
