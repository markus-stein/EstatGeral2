...
\vspace{0.3cm}
MAT02215 - Estatística Geral 2 - 2026/1
}
...
* **Exemplo 2**: Gastos em campanha. Suponha que estamos interessados em comparar os gastos diários na campanha para eleições municipais entre três candidatos diferentes. Podemos dizer que os gastos diários médios nas campanhas são iguais?
