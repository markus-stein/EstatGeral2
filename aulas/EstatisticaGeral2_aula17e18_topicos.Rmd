...
Separamos a soma de quadrados no numerados da variância de uma variável $Y$ em duas partes:
...
### Comparação ente as médias
* Usando intervalos de confiança 
    + Exemplos 15.5 e 15.6 de Bussab e Morettin - seção 15.4.

* no slides usamos o limite de decisão $L_d = 3 \times s_{\overline x}$ ($s_{\overline x}$ é o desvio padrão das médias)
