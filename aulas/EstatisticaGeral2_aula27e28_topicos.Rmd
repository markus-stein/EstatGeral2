...
```{r college_aid, message=FALSE, echo=FALSE, warning=FALSE, fig.width=4, fig.height=2}
# library(ggplot2)
# library(openintro)
# data(COL)
# data(elmhurst)
...
ou seja, os parâmetros $\alpha$ e $\beta$.  
...
* Reta estimada (modelo ajustado): $\widehat y_i = \widehat \alpha + \widehat \beta \cdot x_i$
    ...
    + **Predição**, para um dado valor $X=x$, quanto esperamos observar o valor de $Y$?
