...
* Porém desconhecemos $\pi$?!
    + então usamos seu estimador, a proporção amostral $p$.
...
<!-- Hoje iniciamos nossa última semana da área 1. O plano de aulas da semana, slides e vídeo estão disponíveis. A lista de exercícios seguem como continuaçãpo das semanas anteriores. Também se inicia o período para realização da nossa primeira avliação pontual (prova 1). Até o final do dia disponibilizarei o questionário. Na próxima quarta-feira teremos o encontro para dúvidas.  -->
<!-- Para lembrar quem ainda não realizou a avaliação aprcial 2 da área 1, o prazo se encerra hoje.   -->

<!-- Foi muito bom ver que na avaliação pontual 1 tivemos a participação de mais de 87% de vocês e a nota média foi 7,99, parabéns! -->

<!-- Se cuidem e bons estudos! -->
<!-- Abs. -->
