...
* São **afirmações acerca de parâmetros**.
    + Exemplo: o salário médio, $\mu$, na empresa A é superior a 2 salários mínimos (s.m.), ou seja, 
    + em termos do parêmetro, $\mu \leq 2 s.m.$ ou $\mu > 2s.m.$. 
...
*(nesse caso tivemos o "azar" de ter coletado uma amostra extrema mesmo $H_0$ sendo verdade)*
    + É o erro que priorizamos.
* Erro tipo II: "aceitar" $H_0$ quando $H_0$ for falsa.


### Probabilidade de Erro 
* $\alpha = P(Erro \: I) = P( \left.``rejeitar \: H_0" \right| ``H_0 \: verdadeiro")$.  
    + $\alpha$ é também denominado **nível de significância**.  
* $\beta = P(Erro \: II) = P( \left.``não \: rejeitar \: H_0" \right| ``H_0 \: falsa")$.  
    + $1 - \beta$ é também denominado **poder do teste**.
