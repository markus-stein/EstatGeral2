...
* **(cont.) Exemplo**: Suponha que $\overline x = `r xbarra`$ para uma amostra observada, nesse caso rejeitamos $H_0$, porque $\overline x = `r xbarra` > `r xtab` = \overline x_{crítico}$; ou $z_{calc} = `r zcalc` > `r ztab` = z_{crítico}$.
    + E qual o valor *p*?
